package com.codedifferently.labs.lab02.a_loops.activities;

public class Activity_A01_Loops {
    ...
    //Todo: Create a un-enhanced for-loop to print from 1 to the number entered by the user.
}
